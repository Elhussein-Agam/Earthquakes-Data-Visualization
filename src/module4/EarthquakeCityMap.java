...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {		
		...
		if (offline) {
			...
			map = new UnfoldingMap(this, 200, 50, 650, 600, new ThunderforestProvider.OpenCycleMap());
	...
	private void addKey() {	
		...
		fill(color(255, 0, 0));
		triangle(50, 100, 55, 95, 60, 100);
		
		fill(color(255, 255, 255));
		ellipse(55, 110, 5, 5);
		rect(51f, 120f, 7.5f, 7.5f);
		...
		line(47.5f, 192.5f, 62.5f, 207.5f);
		line(47.5f, 207.5f, 62.5f, 192.5f);
		//fill(color(255, 0, 0));
		...
		text("Size ~ Magnitude", 51, 140);
		text("shallow", 75, 155);
		text("intermediate", 75, 170);
		text("deep", 75, 185);
		text("Past hour", 75, 200);
	...
	private boolean isLand(PointFeature earthquake) {
		...
		for (Marker m : countryMarkers) {
			...
			boolean test = isInCountry(earthquake, m);
			if(test == true){
				return true;
			}
	...
	private void printQuakes() 
	{
		...
		System.out.println("oceanQuikes:" + " " + (quakeMarkers.size() - helper));
