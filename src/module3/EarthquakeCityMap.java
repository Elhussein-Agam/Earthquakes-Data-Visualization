...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {
		...
		if (offline) {
			...
			map = new UnfoldingMap(this, 200, 50, 700, 500, new ThunderforestProvider.OpenCycleMap());
	    ...
	    for(PointFeature eq: earthquakes){
	    	SimplePointMarker myMarker = createMarker(eq);
	...
	*/
	...
	{	
		...
		text("5.0+ Magnitude", 55, 100);
		text("4.0+ Magnitude", 55, 125);
		text("Below 4.0", 55, 150);
